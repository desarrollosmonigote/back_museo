...
const activities = [
  {
    ...
    grado_del_curso: "2° grado ",
    actividad:
      'Busqueda del tesoro (60 minutos) - Sala: "Tiempo de Revolucion" o "Tiempo de Provincias"',
    descripcion:
  ...
  },
  {
    ...
    grado_del_curso: "5° grado",
    actividad:
      'La memoria y los objetos (60 minutos) - Sala: "Tiempo de Revolucion" o "Tiempo de provincias"',
    descripcion:
  ...
  {
    grupo: "Primario (5° a 7° grado)",
    grado_del_curso: "6° grado",
    actividad: 'Recorrido "Tiempo de Revolucion"',
    descripcion:
  ...
  {
    grupo: "Secundario",
    grado_del_curso: "1° año",
    actividad: "Las mujeres en la historia argentina: mas alla del estereotipo",
    descripcion:
  ...
  {
    grupo: "Secundario",
    grado_del_curso: "2° año",
    actividad: "La diversidad cultural en el imaginario nacional argentino",
    descripcion:
  ...
  {
    grupo: "Secundario",
    grado_del_curso: "3° año",
    actividad:
      "Huellas del bajo pueblo en la Revolucion y las Guerras de Independencia",
    descripcion:
      "Cras non velit nec nisi vulputate nonummy. Maecenas tincidunt lacus at velit. Vivamus vel nulla eget eros elementum pellentesque. Quisque porta volutpat erat. Quisque erat eros, viverra eget, congue eget, semper rutrum, nulla. Nunc purus. Phasellus in felis. Donec semper sapien a libero. Nam dui. Proin leo odio, porttitor id, consequat in, consequat ut, nulla. Sed accumsan felis. Ut at dolor quis odio consequat varius. Integer ac leo. Pellentesque ultrices mattis odio. Donec vitae nisi. Nam ultrices, libero non mattis pulvinar, nulla pede ullamcorper augue, a suscipit nulla elit ac nulla. Sed vel enim sit amet nunc viverra dapibus. Nulla suscipit ligula in lacus. Curabitur at ipsum ac tellus semper interdum. Mauris ullamcorper purus sit amet nulla. Quisque arcu libero, rutrum ac, lobortis vel, dapibus at, diam. Nam tristique tortor eu pede.",
  },
  {
    grupo: "Secundario",
    grado_del_curso: "4° año",
    actividad: 'Recorrido "Tiempo de Revolucion"',
    descripcion:
  ...
  {
    grupo: "Nivel terciario y universitario",
    grado_del_curso: "carrera",
    actividad: "Las mujeres en la historia argentina: mas alla del estereotipo",
    descripcion:
...
async function createActivities() {
  try {
    ...
    console.log("ACTIVITIES created Ok");
  } catch (error) {
    console.log(error);
  }
}
